"""tsumiki: AgentSquare evolution tooluse prompts (vendored from Apache-2.0).

Upstream: https://github.com/tsinghua-fib-lab/AgentSquare/blob/8f5b3fe5d8a32f9b59d20370823bef2a2c86928c/module_evolution/prompt_tooluse.py
...
"""
def get_prompt_tooluse(current_archive, last_feedback=None):
