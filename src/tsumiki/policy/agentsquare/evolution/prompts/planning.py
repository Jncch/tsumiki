"""tsumiki: AgentSquare evolution planning prompts (vendored from Apache-2.0).

Upstream: https://github.com/tsinghua-fib-lab/AgentSquare/blob/8f5b3fe5d8a32f9b59d20370823bef2a2c86928c/module_evolution/prompt_planning.py
Vendored at Phase 7e-3 (2026-06-19).
See docs/agentsquare_vendoring.md for vendoring policy.

Phase 7e-3 modifications: 各 prompts ファイル共通 (reasoning.py 冒頭 docstring を参照).
"""
import json
...
def get_prompt_planning(current_archive, last_feedback=None):
    # Phase 7e-3: search/module_evolution.py 呼び出し側 (feedback あり) と互換性を取るため
    # last_feedback 引数を追加. 本実装では未使用.
    _ = last_feedback
